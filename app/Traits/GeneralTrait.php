...
trait GeneralTrait
{
    ...
    public function returnSuccessMsg($successNum = '200', $msg = '')
    {
        return response()->json([
            'status' => 'true',
    ...
    {
        Category::where('id', 'active')->update(['active' => $request->active]);
        return $this->returnSuccessMsg('تم تغيير الحاله بنجاح');
    }
