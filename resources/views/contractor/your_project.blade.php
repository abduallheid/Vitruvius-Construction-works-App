                ...
                <div class="box">
                    ...
                    @if($pro->arch === 'Italian')
                        ...
                        <a href="{{route('contractor.details',$pro->id)}}">
                            ...
                            <a class="btn btn-danger unaccept" href="{{route('contractor.unaccept',$pro->id)}}"><h4>Un Accept</h4></a>
                            @if($pro->contractor_tax == 0)
                            <a href="{{route('contractor.payment',$pro->id)}}" style="background-color:green; font-weight:bold; color:white"><h4>Pay</h4></a><br>
                            @endif
                        </a><br>
                    </div>
                </div>
